...
def main():
    ...
    train_dataset = TextDatasetWithPretrainedEmbeddings(train_df, cache_file=".data/train_embeddings.pt")
    print("Encoding Validation Data...")
    val_dataset = TextDatasetWithPretrainedEmbeddings(val_df, cache_file=".data/val_embeddings.pt")
    print("Encoding Test Data...")
    test_dataset = TextDatasetWithPretrainedEmbeddings(test_df, cache_file=".data/test_embeddings.pt")
